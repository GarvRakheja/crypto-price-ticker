        ...
        React.useCallback(() => {
            const fetchPrices = async () => {
                try {
                    ...
                    const getPositive = response.data.filter((arr) => arr.price_change_percentage_24h > 0)
                    const sortedPositive = getPositive.sort((a, b) => b.price_change_percentage_24h - a.price_change_percentage_24h)
